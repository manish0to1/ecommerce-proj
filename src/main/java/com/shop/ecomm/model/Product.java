...
// }
//
// public Product(Long id, String title, String description, int price, int
// discountedPrice, int discountPersent,
// int quantity, String brand, String color, Set<Size> size, String imageUrl,
// List<Rating> ratings,
// List<Review> reviews, int numRating, Category category, LocalDateTime
// createdAt) {
// super();
// this.id = id;
// this.title = title;
